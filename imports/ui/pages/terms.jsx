...
export  class Terms extends React.Component {
  ...
  <div style={{paddingLeft  : '16px'}}>
    ...
    <div style={styles.text}>
      Welcome to Who's In. By using this website (the “Site”) and services (together with the Site, the “Services”) offered by Who's In, you’re agreeing to these legally binding rules (the “Terms”). <br/><br/>
We may change these terms from time to time. If we do, we’ll let you know about any material changes, either by notifying you on the Site or by sending you an email. New versions of the terms will never apply retroactively — we’ll tell you the exact date they go into effect. If you keep using Who's In after a change, that means you accept the new terms.

<br/><br/>Who's In is for your personal, non-commercial use.
    </div>
    ...
    <div>
      Who's In has some rules and guidelines around what makes a suitable pledge. In general, pledges are supposed to be focused on something that requires mass-participation in order to impact a much larger issue. Pledges of the following types are offered as suggestions for a pledge submission:
...
<br/>•	Don’t try to damage or get unauthorized access to any system, data, password, or other information, whether it belongs to Who's In or another party.
...
<br/>•	Don’t take apart or reverse engineer any aspect of Kickstarter in an effort to access things like source code, underlying ideas, or algorithms.
    ...
    <div style={styles.text}>
      Who's In isn’t liable for any damages or losses related to your use of the Services. We don’t become involved in disputes between users, or between users and any third party relating to the use of the Services. We don’t oversee the performance or punctuality of projects, and we don’t endorse any content users submit to the Site. When you use the Services, you release Who's In from claims, damages, and demands of every kind — known or unknown, suspected or unsuspected, disclosed or undisclosed — arising out of or in any way related to such disputes and the Services. All content you access through the Services is at your own risk. You’re solely responsible for any resulting damage or loss to any party.
<br/><br/>


Who's In may contain links to other websites. (For instance, pledges, user profiles, and comments may link to other sites.) When you access third-party websites, you do so at your own risk. We don’t control or endorse those sites.
    ...
    <div style={styles.text}>
      Who's In doesn’t own content you submit to us (your “Content”). But we do need certain licenses from you in order to perform our Services. When you submit a project for review, or launch a project, you agree to these terms:
...
•	You won’t submit stuff you don’t hold the copyright for (unless you have permission). Your Content will not contain third-party copyrighted material, or material that is subject to other third-party proprietary rights, unless you have permission from the rightful owner of the material, or you are otherwise legally entitled to post the material (and to grant Who's In all the license rights outlined here).
...
•	We’re not responsible for mistakes in your content. Who's In will not be liable for any errors or omissions in any content.

<br/><br/>
Who's In’s Services are legally protected in various ways, including copyrights, trademarks, service marks, patents, trade secrets, and other rights and laws. You agree to respect all copyright and other legal notices, information, and restrictions contained in any content accessed through the Site. You also agree not to change, translate, or otherwise create derivative works of the Service.
Who's In grants you a license to reproduce content from the Services for personal use only. This license covers both Who's In’s own protected content and user-generated content on the Site. (This license is worldwide, non-exclusive, non-sublicensable, and non-transferable.) If you want to use, reproduce, modify, distribute, or store any of this content for a commercial purpose, you need prior written permission from Who's In or the relevant copyright holder. A “commercial purpose” means you intend to use, sell, license, rent, or otherwise exploit content for commercial use, in any way.
...
Who's In reserves these rights:
•	We can make changes to the Who's In Site and Services without notice or liability.
•	We have the right to decide who’s eligible to use Who's In. We can cancel accounts or decline to offer our Services. (Especially if you’re abusing them.) We can change our eligibility criteria at any time. If these things are prohibited by law where you live, then we revoke your right to use Who's In in that jurisdiction.
...
Who's In is not liable for any damages as a result of any of these actions, and it is our policy not to comment on the reasons for any such action.

<br/><br/>
If you do something that gets us sued, or break any of the promises you make in this agreement, you agree to defend, indemnify, and hold us harmless from all liabilities, claims, and expenses (including reasonable attorneys’ fees and other legal costs) that arise from or relate to your use or misuse of Who's In. We reserve the right to assume the exclusive defence and control of any matter otherwise subject to this indemnification clause, in which case you agree that you’ll cooperate and help us in asserting any defences.
